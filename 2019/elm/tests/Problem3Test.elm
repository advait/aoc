...
suite =
    Test.describe "Problem 3"
        [ Test.describe "parsers"
            ...
            , Test.test "wire parser parses one down item" <| \_ -> expectParsedWire [ ( Down, 7 ) ] "D7"
            , Test.test "wire parser parses one left item" <| \_ -> expectParsedWire [ ( Left, 70000 ) ] "L70000"
            , Test.test "wire parser parses one right item" <| \_ -> expectParsedWire [ ( Right, 0 ) ] "R0"
...
expectParsedWire wire inp =
    expectParse Problem3.wireParser inp wire


testInput0 =
    """
R8,U5,L5,D3
U7,R6,D4,L4""" |> String.trim


testInput1 =
    """
R75,D30,R83,U83,L12,D49,R71,U7,L72
U62,R66,U55,R34,D71,R55,D58,R83""" |> String.trim


testInput2 =
    """
R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51
U98,R91,D20,R16,D67,R40,U7,R15,U6,R7""" |> String.trim
