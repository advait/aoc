...
execAmp : Int -> Int -> Int
execAmp ampValue ampInput =
    (comp
        |> Computer.withInputs [ Debug.log "value" ampValue, Debug.log "input" ampInput ]
...
execAmps values =
    List.foldl execAmp 0 values


problemA =
    amplifierValues |> List.map execAmps |> List.maximum
