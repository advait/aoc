...
var author$project$Computer$withMem = function (mem) {
	return {iPtr: 0, input: 0, memory: mem, output: _List_Nil};
};
var author$project$Util$concatMaybes = function (maybes) {
	concatMaybes:
	while (true) {
		if (!maybes.b) {
			return _List_Nil;
			...
			if (maybes.a.$ === 'Nothing') {
				var _n1 = maybes.a;
				var tail = maybes.b;
				var $temp$maybes = tail;
				maybes = $temp$maybes;
				continue concatMaybes;
			} else {
				var a = maybes.a.a;
				var tail = maybes.b;
				return A2(
					elm$core$List$cons,
					a,
					author$project$Util$concatMaybes(tail));
			}
		}
	}
};
...
var author$project$Util$readInts = function (input) {
	return author$project$Util$concatMaybes(
		A2(
			elm$core$List$map,
...
var author$project$Computer$fromString = function (input) {
	var memory = elm$core$Array$fromList(
		author$project$Util$readInts(
			A2(
				elm$core$String$join,
				'\n',
				A2(elm$core$String$split, ',', input))));
	return author$project$Computer$withMem(memory);
};
var author$project$Computer$withInput = F2(
	function (input, comp) {
		return _Utils_update(
			comp,
			{input: input});
	});
var author$project$ComputerViewer$dummyInput = '3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99';
var author$project$ComputerViewer$init = {
	comp: A2(
		author$project$Computer$withInput,
		1,
		author$project$Computer$fromString(author$project$ComputerViewer$dummyInput)),
	prevComps: _List_Nil
};
var author$project$Computer$Halt = {$: 'Halt'};
var author$project$Computer$Add = F3(
	function (a, b, c) {
		return {$: 'Add', a: a, b: b, c: c};
	});
var author$project$Computer$Equals = F3(
	function (a, b, c) {
		return {$: 'Equals', a: a, b: b, c: c};
	});
var author$project$Computer$Input = function (a) {
	return {$: 'Input', a: a};
};
var author$project$Computer$JumpIfFalse = F2(
	function (a, b) {
		return {$: 'JumpIfFalse', a: a, b: b};
	});
var author$project$Computer$JumpIfTrue = F2(
	function (a, b) {
		return {$: 'JumpIfTrue', a: a, b: b};
	});
var author$project$Computer$LessThan = F3(
	function (a, b, c) {
		return {$: 'LessThan', a: a, b: b, c: c};
	});
var author$project$Computer$Mul = F3(
	function (a, b, c) {
		return {$: 'Mul', a: a, b: b, c: c};
	});
var author$project$Computer$Output = function (a) {
	return {$: 'Output', a: a};
};
...
var author$project$Computer$readOp = function (comp) {
	var readMem = function (relativePos) {
		return A2(elm$core$Array$get, relativePos, comp.memory);
	};
	var immParamValue = function (index) {
		return readMem(comp.iPtr + index);
	};
	var fullOpcode = readMem(comp.iPtr);
	var isImmediateMode = function (paramIndex) {
		return A2(
			elm$core$Maybe$map,
			function (i) {
				return A2(elm$core$Basics$modBy, 10, i) === 1;
			},
			A2(
				elm$core$Maybe$map,
				function (opc) {
					return (opc / A2(elm$core$Basics$pow, 10, paramIndex + 1)) | 0;
				},
				fullOpcode));
	};
	var immOrPosParamValue = function (index) {
		return A2(
			elm$core$Maybe$andThen,
			function (isImmediate) {
				return isImmediate ? immParamValue(index) : A2(
					elm$core$Maybe$andThen,
					function (loc) {
						return readMem(loc);
					},
		...
		if (opcode.$ === 'Just') {
			switch (opcode.a) {
				case 1:
					return A4(
						elm$core$Maybe$map3,
						author$project$Computer$Add,
						immOrPosParamValue(1),
						immOrPosParamValue(2),
						immParamValue(3));
				case 2:
					return A4(
						elm$core$Maybe$map3,
						author$project$Computer$Mul,
						immOrPosParamValue(1),
						immOrPosParamValue(2),
						immParamValue(3));
				case 3:
					return A2(
						elm$core$Maybe$map,
						author$project$Computer$Input,
						immParamValue(1));
				case 4:
					return A2(
						elm$core$Maybe$map,
						author$project$Computer$Output,
						immOrPosParamValue(1));
				case 5:
					return A3(
						elm$core$Maybe$map2,
						author$project$Computer$JumpIfTrue,
						immOrPosParamValue(1),
						immOrPosParamValue(2));
				case 6:
					return A3(
						elm$core$Maybe$map2,
						author$project$Computer$JumpIfFalse,
						immOrPosParamValue(1),
						immOrPosParamValue(2));
				case 7:
					return A4(
						elm$core$Maybe$map3,
						author$project$Computer$LessThan,
						immOrPosParamValue(1),
						immOrPosParamValue(2),
						immParamValue(3));
				case 8:
					return A4(
						elm$core$Maybe$map3,
						author$project$Computer$Equals,
						immOrPosParamValue(1),
						immOrPosParamValue(2),
						immParamValue(3));
				case 99:
					return elm$core$Maybe$Just(author$project$Computer$Halt);
				default:
					break _n0$9;
			}
		} else {
...
var author$project$Computer$isHalted = function (comp) {
	return _Utils_eq(
		author$project$Computer$readOp(comp),
		elm$core$Maybe$Just(author$project$Computer$Halt));
};
var author$project$Computer$AddIPtr = function (a) {
	return {$: 'AddIPtr', a: a};
};
var author$project$Computer$AppendOutput = function (a) {
	return {$: 'AppendOutput', a: a};
};
var author$project$Computer$SetIPtr = function (a) {
	return {$: 'SetIPtr', a: a};
};
var author$project$Computer$Store = F2(
	function (a, b) {
		return {$: 'Store', a: a, b: b};
	});
var author$project$Computer$StoreInputInto = function (a) {
	return {$: 'StoreInputInto', a: a};
};
var author$project$Util$boolToInt = function (bool) {
	if (bool) {
		return 1;
	} else {
		return 0;
...
var author$project$Computer$execOp = function (op) {
	switch (op.$) {
		case 'Add':
			var p1 = op.a;
			var p2 = op.b;
			...
			return _List_fromArray(
				[
					A2(author$project$Computer$Store, p1 + p2, dest),
					author$project$Computer$AddIPtr(4)
				]);
		case 'Mul':
			var p1 = op.a;
			var p2 = op.b;
		...
		case 'Input':
			...
			return _List_fromArray(
				[
					author$project$Computer$StoreInputInto(dest),
					author$project$Computer$AddIPtr(2)
				]);
		case 'Output':
			var dest = op.a;
			return _List_fromArray(
				[
					author$project$Computer$AppendOutput(dest),
					author$project$Computer$AddIPtr(2)
				]);
		case 'JumpIfTrue':
			var p1 = op.a;
			var dest = op.b;
			return p1 ? _List_fromArray(
				[
					author$project$Computer$SetIPtr(dest)
				]) : _List_fromArray(
				[
					author$project$Computer$AddIPtr(3)
				]);
		case 'JumpIfFalse':
			var p1 = op.a;
			var dest = op.b;
		...
		case 'LessThan':
			...
			return _List_fromArray(
				[
					A2(
					author$project$Computer$Store,
					author$project$Util$boolToInt(
						_Utils_cmp(p1, p2) < 0),
					dest),
					author$project$Computer$AddIPtr(4)
				]);
...
var author$project$Computer$execStateT = F2(
	function (stateT, comp) {
		switch (stateT.$) {
			case 'Store':
				var val = stateT.a;
				var dest = stateT.b;
				return _Utils_update(
					comp,
					{
						memory: A3(elm$core$Array$set, dest, val, comp.memory)
					});
			case 'AddIPtr':
				var jmp = stateT.a;
				return _Utils_update(
			...
			case 'StoreInputInto':
				...
				return _Utils_update(
					comp,
					{
						memory: A3(elm$core$Array$set, dest, comp.input, comp.memory)
					});
			default:
				var val = stateT.a;
				return _Utils_update(
					comp,
					{
						output: A2(elm$core$List$cons, val, comp.output)
					});
		}
	});
var author$project$Computer$stepOnce = function (comp) {
	var op = author$project$Computer$readOp(comp);
	var stateTs = A2(elm$core$Maybe$map, author$project$Computer$execOp, op);
	var finalComp = A2(
		elm$core$Maybe$map,
		A2(elm$core$List$foldl, author$project$Computer$execStateT, comp),
		stateTs);
	return finalComp;
};
var author$project$ComputerViewer$update = F2(
	function (msg, model) {
		if (msg.$ === 'StepForward') {
			if (author$project$Computer$isHalted(model.comp)) {
				return model;
			} else {
				var _n1 = author$project$Computer$stepOnce(model.comp);
				if (_n1.$ === 'Nothing') {
					return model;
				} else {
					var nextComp = _n1.a;
					return _Utils_update(
						...
						{
							comp: nextComp,
							prevComps: A2(elm$core$List$cons, model.comp, model.prevComps)
						});
				}
			}
		} else {
			var _n2 = model.prevComps;
			if (_n2.b) {
				var head = _n2.a;
				var tail = _n2.b;
				return _Utils_update(
					model,
					{comp: head, prevComps: tail});
			} else {
				return model;
			}
		}
	});
var author$project$ComputerViewer$StepBackward = {$: 'StepBackward'};
var author$project$ComputerViewer$StepForward = {$: 'StepForward'};
...
var surprisetalk$elm_bulma$Bulma$Elements$connectedButtons = function (alignment) {
	return A2(
		elm$core$Basics$composeL,
		surprisetalk$elm_bulma$Bulma$Elements$buttons(alignment),
		elm$core$List$cons(
			elm$html$Html$Attributes$class('has-addons')));
};
...
var author$project$ComputerViewer$viewCommands = function (model) {
	var forwardDisabled = author$project$Computer$isHalted(model.comp);
	var backwardDisabled = _Utils_eq(model.prevComps, _List_Nil);
	return _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3(
							surprisetalk$elm_bulma$Bulma$Elements$connectedButtons,
							surprisetalk$elm_bulma$Bulma$Modifiers$Centered,
							_List_Nil,
							_List_fromArray(
								[
									A3(
									...
									_Utils_update(
										...
										{color: surprisetalk$elm_bulma$Bulma$Modifiers$Warning, inverted: backwardDisabled}),
									_List_fromArray(
										[
											elm$html$Html$Events$onClick(author$project$ComputerViewer$StepBackward)
										]),
									_List_fromArray(
										[
									...
									_Utils_update(
										surprisetalk$elm_bulma$Bulma$Elements$buttonModifiers,
										{color: surprisetalk$elm_bulma$Bulma$Modifiers$Primary, inverted: forwardDisabled}),
									_List_fromArray(
										[
											elm$html$Html$Events$onClick(author$project$ComputerViewer$StepForward)
										]),
									_List_fromArray(
										[
...
var author$project$ComputerViewer$viewInternals = function (comp) {
	return _List_fromArray(
		[
			A2(
			surprisetalk$elm_bulma$Bulma$Components$card,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('Transformations')
								])),
							A2(
							surprisetalk$elm_bulma$Bulma$Elements$box,
							_List_Nil,
							_List_fromArray(
								[
									...
									elm$core$Debug$toString(
										A2(
											elm$core$Maybe$map,
											author$project$Computer$execOp,
											author$project$Computer$readOp(comp))))
								])),
							A3(
							surprisetalk$elm_bulma$Bulma$Elements$title,
							...
							_List_fromArray(
								[
									elm$html$Html$text(
									elm$core$Debug$toString(comp.input))
								])),
							A3(
							surprisetalk$elm_bulma$Bulma$Elements$title,
							surprisetalk$elm_bulma$Bulma$Elements$H4,
							...
							_List_fromArray(
								[
									elm$html$Html$text(
									elm$core$Debug$toString(comp.output))
								]))
						]))
				]))
		]);
...
var author$project$ComputerViewer$viewMemory = function (comp) {
	var viewMemoryCell = elm$core$Array$toList(
		A2(
					...
					_List_fromArray(
						[
							...
							_Utils_update(
								...
								{bordered: true, hoverable: true, striped: true}),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									A2(surprisetalk$elm_bulma$Bulma$Elements$tableBody, _List_Nil, viewMemoryCell)
								]))
						]))
				]))
		]);
};
var surprisetalk$elm_bulma$Bulma$Columns$Gap8 = {$: 'Gap8'};
...
var surprisetalk$elm_bulma$Bulma$Columns$narrowColumnModifiers = {
	offset: surprisetalk$elm_bulma$Bulma$Modifiers$Auto,
	widths: {desktop: elm$core$Maybe$Nothing, fullHD: elm$core$Maybe$Nothing, mobile: elm$core$Maybe$Nothing, tablet: elm$core$Maybe$Nothing, widescreen: elm$core$Maybe$Nothing}
};
...
var author$project$ComputerViewer$viewColumns = function (model) {
	return A3(
				...
				_List_fromArray(
					[
						...
						_Utils_update(
							...
							{gap: surprisetalk$elm_bulma$Bulma$Columns$Gap8}),
						_List_Nil,
						_List_fromArray(
							[
								A3(
								surprisetalk$elm_bulma$Bulma$Columns$column,
								surprisetalk$elm_bulma$Bulma$Columns$narrowColumnModifiers,
								_List_Nil,
								author$project$ComputerViewer$viewCommands(model)),
								A3(
								surprisetalk$elm_bulma$Bulma$Columns$column,
								surprisetalk$elm_bulma$Bulma$Columns$columnModifiers,
								_List_Nil,
								author$project$ComputerViewer$viewInternals(model.comp)),
								A3(
								surprisetalk$elm_bulma$Bulma$Columns$column,
								surprisetalk$elm_bulma$Bulma$Columns$narrowColumnModifiers,
								_List_Nil,
								author$project$ComputerViewer$viewMemory(model.comp))
							]))
					]))
			]));
};
...
var author$project$ComputerViewer$viewHero = A3(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('AOC: Intcode Emulator')
								])),
							A3(
							...
							_List_fromArray(
								[
									elm$html$Html$text('Simulate the '),
									A2(
									elm$html$Html$a,
									_List_fromArray(
										[
											elm$html$Html$Attributes$href('https://adventofcode.com/2019/day/5')
										]),
									_List_fromArray(
										[
											elm$html$Html$text('Advent of Code')
										])),
									elm$html$Html$text(' intcode computer!')
								]))
						]))
				]))
		]));
...
var surprisetalk$elm_bulma$Bulma$CDN$stylesheet = A3(
	...
	_List_Nil);
var author$project$ComputerViewer$view = function (model) {
	return A2(
		elm$html$Html$main_,
		_List_Nil,
		_List_fromArray(
			[
				...
				author$project$ComputerViewer$viewHero,
				author$project$ComputerViewer$viewColumns(model)
			]));
};
...
var author$project$ComputerViewer$main = elm$browser$Browser$sandbox(
	{init: author$project$ComputerViewer$init, update: author$project$ComputerViewer$update, view: author$project$ComputerViewer$view});
_Platform_export({'ComputerViewer':{'init':author$project$ComputerViewer$main(
